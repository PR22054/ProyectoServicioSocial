...
@section('page_title', 'Editar Realización')

@section('page_content')

{{-- FORMULARIO PARA CORREGIR UNA REALIZACION YA REGISTRADA --}}
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Editar realización #{{ $realizacion->id }}</h3>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.especies.realizaciones.update', $realizacion) }}">
                @csrf @method('PATCH')
                        ...
                        <div class="form-group">
                            ...
                            <select name="distrito_id" id="distrito_id"
                                ...
                                @foreach($distritos as $d)
                                    <option value="{{ $d->id }}"
                                        {{ old('distrito_id', $realizacion->distrito_id) == $d->id ? 'selected' : '' }}>
                                        {{ $d->nombre }} ({{ $d->codigo }})
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="tipo_especie_id" id="tipo_especie_id"
                                ...
                                @foreach($tipos as $t)
                                    <option value="{{ $t->id }}"
                                        {{ old('tipo_especie_id', $realizacion->tipo_especie_id) == $t->id ? 'selected' : '' }}>
                                        {{ $t->nombre }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="numero_inicio" id="numero_inicio"
                                   ...
                                   value="{{ old('numero_inicio', $realizacion->numero_inicio) }}" min="1" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="numero_fin" id="numero_fin"
                                   ...
                                   value="{{ old('numero_fin', $realizacion->numero_fin) }}" min="1" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre_contribuyente"
                           ...
                           value="{{ old('nombre_contribuyente', $realizacion->nombre_contribuyente) }}"
                           placeholder="Nombre de quien realizó el trámite">
                </div>

                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.especies.realizaciones.historial') }}" class="btn btn-secondary">
                        Cancelar
                    </a>
