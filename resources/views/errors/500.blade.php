...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .code { font-size: 5rem; font-weight: 700; color: #dc3545; line-height: 1; }
...
<body>
    <div class="card">
        ...
        <p>Ocurrio un error inesperado. Por favor intente de nuevo o contacte al administrador del sistema.</p>
        <div class="actions">
