...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .code { font-size: 5rem; font-weight: 700; color: #17a2b8; line-height: 1; }
...
<body>
    <div class="card">
        ...
        <p>Tu sesion expiro o el token de seguridad no es valido. Recarga la pagina e intenta de nuevo.</p>
        <div class="actions">
